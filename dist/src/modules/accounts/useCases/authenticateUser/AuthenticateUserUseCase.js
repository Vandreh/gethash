...
var AuthenticateUserUseCase = /** @class */ (function () {
    ...
    AuthenticateUserUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user, passwordMatch, token, tokenReturn;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.userRepository.findByName(name)];
                    case 1:
                        user = _b.sent();
                        if (!user) {
                            throw new AppError_1.AppError("Name or password incorrect");
                        }
                    ...
                    case 2:
                        ...
                        token = (0, jsonwebtoken_1.sign)({}, "7623ca46bf343099089d266619fc2139", {
                            subject: user.id,
                            expiresIn: "1d"
                        });
                        tokenReturn = {
